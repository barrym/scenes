...
describe Cast do
  ...
  it "should add new cast members"

  it "should be able to clear the list of class members"

  it "should show a list of cast members"

  it "should be able to duplicate itself"
